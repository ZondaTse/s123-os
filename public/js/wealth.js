...
// ══════════════════════════════════════════════════════
// 工资规则配置 — 显示在每张员工卡片名字下方
// ══════════════════════════════════════════════════════
const SALARY_RULES = {
  '孔敏怡':  '底薪¥4,900 + 补贴¥500 + 全勤¥300，社保-¥650',
  '伍华彩':  '底薪¥6,500 + 补贴¥500 + 全勤¥300 + 加班费，社保-¥650',
  '赵姗姗':  '底薪¥6,700 + 补贴¥500 + 全勤¥300 + 加班费，社保-¥650',
  '赵佳琪':  '底薪¥5,700 + 补贴¥500 + 全勤¥300，社保-¥650；产假期间停发',
  '莫翠玲':  '固定工资¥8,200（居家办公，无社保）',
  '莫碧君':  '固定工资¥8,200（居家办公，无社保）',
  '陈嘉仪':  '底薪¥6,700 + 补贴¥500 + 全勤¥300 + 加班费，社保-¥480',
  '郭锋原':  '底薪¥9,800 + 补贴¥500 + 全勤¥300 + 固定加班¥2,000 + GMV提成，社保-¥650',
  '黄东亮':  '底薪¥7,200 + 补贴¥500 + 全勤¥300 + GMV提成，社保-¥650',
  '伍尚康':  '底薪¥9,200 + 补贴¥500 + 全勤¥300，社保-¥650',
  '王靖允':  '底薪¥6,200 + 补贴¥500 + GMV提成，请假按天扣，社保-¥650',
  '杨欣':    '底薪¥7,000 + 补贴¥500 + 全勤¥300 + 加班费 + GMV提成，社保-¥480',
  '唐恺':    '底薪¥5,200 + 补贴¥500 + GMV提成，请假按天扣，社保-¥650',
  '胡可财':  '底薪¥3,700 + 补贴¥500 + 全勤¥300 + GMV提成，社保-¥480',
  '许朝阳':  '底薪¥5,200 + 补贴¥500 + 全勤¥300 + 加班费 + GMV提成，社保-¥650',
  '张妍柔':  '底薪¥7,200 + 补贴¥500 + 全勤¥300，社保-¥480',
  '林汝荣':  '底薪¥6,200 + 补贴¥500 + 全勤¥300 + 固定加班¥3,000，社保-¥650',
  '项柯桥':  '底薪¥5,200 + 补贴¥500 + 全勤¥300 + 加班费，社保-¥650',
  '黄龙光':  '底薪¥4,600（按标准发放），社保-¥650',
  '谢克卓':  '底薪¥5,200 + 补贴¥500 + 全勤¥300 + 加班费，社保-¥650',
  '林健欢':  '底薪¥7,200 + 补贴¥500 + 全勤¥300，社保-¥650',
  '陈奕友':  '固定工资¥5,350（底薪¥6,000 - 社保¥650）',
  '梁梦娜':  '固定工资¥7,000（含一切）',
  '肖煌':    '底薪¥7,200 + 补贴¥500 + 全勤¥300 + 加班费，拿衣服-¥10/次，社保-¥1,300',
  '梁想贤':  '底薪¥4,200 + 补贴¥500 + 全勤¥300 + 加班费 + 仓库绩效，拿衣服-¥10/次，社保-¥700',
  '梁苑斌':  '底薪¥2,700 + 补贴¥500 + 全勤¥300 + 加班费 + 仓库绩效，拿衣服-¥10/次，社保-¥700',
  '何均伟':  '底薪¥2,700 + 补贴¥500 + 全勤¥300 + 加班费 + 仓库绩效，社保-¥480',
  '黄扬明':  '底薪按出勤天数折算 + 仓库绩效，拿衣服-¥10/次，社保-¥480',
  '林庆霞':  '底薪¥3,150（按出勤天数折算）+ 加班费 + 仓库绩效，罚款-¥20/次，社保-¥480；无全勤',
  '金丽桃':  '底薪¥3,080（按出勤天数折算）+ 加班费 + 仓库绩效，拿衣服-¥10/次，社保-¥480',
  '庞金茹':  '底薪¥3,150（按出勤天数折算）+ 加班费 + 仓库绩效，罚款-¥20/次，社保-¥480',
  '陈招汉':  '底薪¥3,220（按出勤天数折算）+ 加班费 + 仓库绩效，社保-¥700',
  '庞智鹏':  '底薪¥3,080（按出勤天数折算）+ 加班费 + 仓库绩效，社保-¥480',
  '董金源':  '底薪¥2,380（按出勤天数折算）+ 加班费 + 仓库绩效，社保-¥480',
  '莫智雄':  '底薪¥5,700 + 补贴¥500 + 全勤¥300，社保-¥650',
  '梁启凡':  '固定工资¥5,350（底薪¥6,000 - 社保¥650）',
  '梁丽云':  '底薪¥3,784（按出勤天数折算）+ 加班费 + 售后绩效，社保-¥700',
  '胡海云':  '底薪¥2,940（按出勤天数折算）+ 售后绩效（无社保）',
  '陈仲竹':  '底薪¥3,080（按出勤天数折算）+ 加班费 + 售后绩效（无社保）',
  '吴美':    '底薪¥3,150（按出勤天数折算）+ 加班费 + 售后绩效 + 其他补贴¥200（无社保）',
};

// ── 赵佳琪产假停发开关 ─────────────────────────────────────
// true = 停发（产假中），false = 正常发放
const ZHAO_JIAQING_MATERNITY_LEAVE = true;
...
const peopleApr = [
  {name:'孔敏怡',dept:'运营',may:5050,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:4900,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'伍华彩',dept:'美工',may:6910,apr:0,type:'neu',reason:'全勤¥300，加班¥260。',bars:[{n:'底薪',may:6500,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:260,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'赵姗姗',dept:'美工',may:7118,apr:0,type:'neu',reason:'全勤¥300，加班¥268。',bars:[{n:'底薪',may:6700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:268,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'赵佳琪',dept:'客服',may:5850,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:5700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'莫翠玲',dept:'阳江客服',may:8200,apr:0,type:'neu',reason:'底薪+各项按标准发放。',bars:[{n:'底薪',may:8200,apr:0}]},
  {name:'莫碧君',dept:'阳江客服',may:8200,apr:0,type:'neu',reason:'底薪+各项按标准发放。',bars:[{n:'底薪',may:8200,apr:0}]},
  {name:'陈嘉仪',dept:'阳江客服',may:7422,apr:0,type:'neu',reason:'全勤¥300，加班¥402。',bars:[{n:'底薪',may:6700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:402,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'郭锋原',dept:'直播办公室',may:12790,apr:0,type:'neu',reason:'全勤¥300，加班¥2000，绩效提成¥840。',bars:[{n:'底薪',may:9800,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:2000,apr:0},{n:'提成',may:840,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'黄东亮',dept:'直播办公室',may:7754.2,apr:0,type:'neu',reason:'全勤¥300，绩效提成¥404.2。',bars:[{n:'底薪',may:7200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'提成',may:404.2,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'伍尚康',dept:'直播办公室',may:9350,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:9200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'王靖允',dept:'直播办公室',may:5648.26,apr:0,type:'neu',reason:'绩效提成¥218.26，请假扣¥620。',bars:[{n:'底薪',may:6200,apr:0},{n:'补贴',may:500,apr:0},{n:'提成',may:218.26,apr:0},{n:'请假扣',may:-620,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'杨欣',dept:'直播办公室',may:8120.84,apr:0,type:'neu',reason:'全勤¥300，加班¥674.07，绩效提成¥126.77。',bars:[{n:'底薪',may:7000,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:674.07,apr:0},{n:'提成',may:126.77,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'唐恺',dept:'直播办公室',may:5054.6,apr:0,type:'neu',reason:'绩效提成¥351.27，请假扣¥346.67。',bars:[{n:'底薪',may:5200,apr:0},{n:'补贴',may:500,apr:0},{n:'提成',may:351.27,apr:0},{n:'请假扣',may:-346.67,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'胡可财',dept:'直播办公室',may:4146.77,apr:0,type:'neu',reason:'全勤¥300，绩效提成¥126.77。',bars:[{n:'底薪',may:3700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'提成',may:126.77,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'许朝阳',dept:'直播办公室',may:6143.93,apr:0,type:'neu',reason:'全勤¥300，加班¥500，绩效提成¥293.93。',bars:[{n:'底薪',may:5200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:500,apr:0},{n:'提成',may:293.93,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'张妍柔',dept:'直播办公室',may:7520,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:7200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'林汝荣',dept:'剪辑号',may:9350,apr:0,type:'neu',reason:'全勤¥300，加班¥3000。',bars:[{n:'底薪',may:6200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:3000,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'项柯桥',dept:'剪辑号',may:5558,apr:0,type:'neu',reason:'全勤¥300，加班¥208。',bars:[{n:'底薪',may:5200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:208,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'黄龙光',dept:'剪辑号',may:3950,apr:0,type:'neu',reason:'底薪+各项按标准发放。',bars:[{n:'底薪',may:4600,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'谢克卓',dept:'陈先生项目',may:5558,apr:0,type:'neu',reason:'全勤¥300，加班¥208。',bars:[{n:'底薪',may:5200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:208,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'林健欢',dept:'陈先生项目',may:7350,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:7200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'陈奕友',dept:'陈先生项目',may:5350,apr:0,type:'neu',reason:'底薪+各项按标准发放。',bars:[{n:'底薪',may:6000,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'梁梦娜',dept:'陈先生项目',may:7000,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:5200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0}]},
  {name:'肖煌',dept:'仓库',may:7690,apr:0,type:'neu',reason:'全勤¥300，加班¥1000，罚款¥10。',bars:[{n:'底薪',may:7200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:1000,apr:0},{n:'罚款',may:-10,apr:0},{n:'社保',may:-1300,apr:0}]},
  {name:'梁想贤',dept:'仓库',may:6127.85,apr:0,type:'neu',reason:'全勤¥300，加班¥168，绩效提成¥1669.85，罚款¥10。',bars:[{n:'底薪',may:4200,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:168,apr:0},{n:'提成',may:1669.85,apr:0},{n:'罚款',may:-10,apr:0},{n:'社保',may:-700,apr:0}]},
  {name:'梁苑斌',dept:'仓库',may:7212.32,apr:0,type:'neu',reason:'全勤¥300，加班¥160，绩效提成¥4262.32，罚款¥10。',bars:[{n:'底薪',may:2700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:160,apr:0},{n:'提成',may:4262.325,apr:0},{n:'罚款',may:-10,apr:0},{n:'社保',may:-700,apr:0}]},
  {name:'何均伟',dept:'仓库',may:7137.16,apr:0,type:'neu',reason:'全勤¥300，加班¥300，绩效提成¥3817.16。',bars:[{n:'底薪',may:2700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'加班',may:300,apr:0},{n:'提成',may:3817.165,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'黄扬明',dept:'仓库',may:5979.2,apr:0,type:'neu',reason:'绩效提成¥3179.2，罚款¥10。',bars:[{n:'底薪',may:3290,apr:0},{n:'提成',may:3179.2,apr:0},{n:'罚款',may:-10,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'林庆霞',dept:'仓库',may:5008.38,apr:0,type:'neu',reason:'加班¥200，绩效提成¥2158.38，罚款¥20。',bars:[{n:'底薪',may:3150,apr:0},{n:'加班',may:200,apr:0},{n:'提成',may:2158.38,apr:0},{n:'罚款',may:-20,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'金丽桃',dept:'仓库',may:5897.62,apr:0,type:'neu',reason:'加班¥360，绩效提成¥2947.62，罚款¥10。',bars:[{n:'底薪',may:3080,apr:0},{n:'加班',may:360,apr:0},{n:'提成',may:2947.62,apr:0},{n:'罚款',may:-10,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'庞金茹',dept:'仓库',may:5405.42,apr:0,type:'neu',reason:'加班¥360，绩效提成¥2395.42，罚款¥20。',bars:[{n:'底薪',may:3150,apr:0},{n:'加班',may:360,apr:0},{n:'提成',may:2395.42,apr:0},{n:'罚款',may:-20,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'陈招汉',dept:'仓库',may:6564.56,apr:0,type:'neu',reason:'加班¥300，绩效提成¥3744.57。',bars:[{n:'底薪',may:3220,apr:0},{n:'加班',may:300,apr:0},{n:'提成',may:3744.565,apr:0},{n:'社保',may:-700,apr:0}]},
  {name:'庞智鹏',dept:'仓库',may:4585.75,apr:0,type:'neu',reason:'加班¥100，绩效提成¥1885.75。',bars:[{n:'底薪',may:3080,apr:0},{n:'加班',may:100,apr:0},{n:'提成',may:1885.75,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'董金源',dept:'仓库',may:4878.84,apr:0,type:'neu',reason:'加班¥40，绩效提成¥2938.84。',bars:[{n:'底薪',may:2380,apr:0},{n:'加班',may:40,apr:0},{n:'提成',may:2938.835,apr:0},{n:'社保',may:-480,apr:0}]},
  {name:'莫智雄',dept:'仓库',may:5850,apr:0,type:'neu',reason:'全勤¥300。',bars:[{n:'底薪',may:5700,apr:0},{n:'补贴',may:500,apr:0},{n:'全勤',may:300,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'梁启凡',dept:'仓库',may:5350,apr:0,type:'neu',reason:'底薪+各项按标准发放。',bars:[{n:'底薪',may:6000,apr:0},{n:'社保',may:-650,apr:0}]},
  {name:'梁丽云',dept:'售后',may:5209.7,apr:0,type:'neu',reason:'加班¥40，绩效提成¥2085.7。',bars:[{n:'底薪',may:3784,apr:0},{n:'加班',may:40,apr:0},{n:'提成',may:2085.7,apr:0},{n:'社保',may:-700,apr:0}]},
  {name:'胡海云',dept:'售后',may:4727.12,apr:0,type:'neu',reason:'绩效提成¥1787.12。',bars:[{n:'底薪',may:2940,apr:0},{n:'提成',may:1787.12,apr:0}]},
  {name:'陈仲竹',dept:'售后',may:5721.08,apr:0,type:'neu',reason:'加班¥120，绩效提成¥2521.08。',bars:[{n:'底薪',may:3080,apr:0},{n:'加班',may:120,apr:0},{n:'提成',may:2521.08,apr:0}]},
  {name:'吴美',dept:'售后',may:5146.64,apr:0,type:'neu',reason:'加班¥110，绩效提成¥1686.64，补贴¥200。',bars:[{n:'底薪',may:3150,apr:0},{n:'加班',may:110,apr:0},{n:'提成',may:1686.64,apr:0},{n:'其他',may:200,apr:0}]}
];
...
const peopleMay = [
  ...
  {name:'林庆霞',dept:'仓库',may:4988,apr:5008,type:'dn',reason:'本月无全勤奖(-300)，加班费¥180，绩效提成¥2,158；上月同样无全勤。',bars:[{n:'底薪',may:3150,apr:3150},{n:'补贴',may:0,apr:0},{n:'全勤',may:0,apr:0},{n:'加班',may:180,apr:200},{n:'提成',may:2158,apr:2158},{n:'罚款',may:-20,apr:-20},{n:'社保',may:-480,apr:-480}]},
...
const monthMeta = {
  ...
  5: {
    ...
    prevTotal: 257886,
    label: '5月',
    summary: '5月总工资较4月增加 <span style="color:var(--s-red);font-weight:600;">¥5,407（+2.1%）</span>，主要来自仓库及直播组加班费普遍计入。郭锋原/杨欣/许朝阳/黄东亮 GMV提成待补，补完后总额将进一步上涨。',
...
function sp_renderCards(filter) {
  ...
  if(isTypeFilter){
    if(filter==='high'){ list=[...list].sort((a,b)=>b.may-a.may); }
    else if(filter==='low'){ list=[...list].sort((a,b)=>a.may-b.may); }
    else{ list=list.filter(p=>p.type===filter); }
  ...
  card.innerHTML = `
    <div class="card-top">
      <div>
        ...
        ${rule ? `<div class="card-rule" style="margin-top:2px">${rule}</div>` : ''}
      </div>
...
function sp_openSheet(idx,list){
  ...
  requestAnimationFrame(function(){
    ...
    if (_nameDiv) {
      _nameDiv.style.cssText = 'font-size:20px;font-weight:700;color:var(--s-fg)';
      _nameDiv.textContent = p.name;
      let _deptEl = sheet.querySelector('.sp-dept-line');
      if (!_deptEl) {
        const _wrap = _nameDiv.parentNode;
        _wrap.style.cssText = 'display:flex;align-items:baseline;gap:5px;flex-wrap:wrap;padding:10px 16px 0';
        _deptEl = document.createElement('span');
        _deptEl.className = 'sp-dept-line';
        _deptEl.style.cssText = 'font-size:12px;color:var(--s-fg4);font-weight:400';
        _wrap.appendChild(_deptEl);
        const _ruleEl = document.createElement('div');
        _ruleEl.className = 'sp-rule-line';
        _ruleEl.style.cssText = 'width:100%;font-size:11px;color:var(--s-fg4);line-height:1.4;padding:2px 16px 6px';
        _wrap.parentNode.insertBefore(_ruleEl, _wrap.nextSibling);
      }
      _deptEl.textContent = p.dept;
      const _ruleEl = sheet.querySelector('.sp-rule-line');
      if (_ruleEl) _ruleEl.textContent = (typeof SALARY_RULES !== 'undefined' && SALARY_RULES[p.name]) || '';
    }

    // 停发徽章
    const badge = document.getElementById('sp-d-badge');
    if (badge) {
      badge.innerHTML = (p.may===0 && p.apr>0)
        ? '<span style="font-size:11px;font-weight:600;color:var(--s-orange);background:rgba(255,149,0,0.12);border:1px solid var(--s-orange);border-radius:6px;padding:2px 7px">停发</span>'
        : '';
    }
    ...
    const diffBg    = diff==null?'var(--s-bg3)':diff>0?'var(--s-tint-red)':diff<0?'var(--s-tint-green)':'var(--s-bg3)';
    const diffColor = diff==null?'var(--s-fg4)':diff>0?'var(--s-red)':diff<0?'var(--s-green)':'var(--s-fg4)';
    const pctVal = hasApr ? ((diff/p.apr)*100).toFixed(1) : null;
    const diffAmt = hasApr ? (diff>0?'+':diff<0?'-':'')+'¥'+Math.abs(diff).toLocaleString('zh-CN') : '—';
    const diffPct = hasApr ? (diff>=0?'+':'')+Math.abs(pctVal)+'%' : '—';
    ...
    document.getElementById('sp-d-compare').innerHTML =
      '<div class="sheet-kpi-row">' +
        '<div class="sheet-kpi" style="background:var(--s-kpi-prev-bg)">' +
          ...
          '<div class="sheet-kpi-val" style="color:var(--s-kpi-prev-fg)">' + (hasApr?'¥'+sp_fmt(p.apr):'—') + '</div>' +
        '</div>' +
    ...
    const fmtRmb = function(v){ return v===0?'—':(v<0?'-¥'+sp_fmt(Math.abs(v)):'¥'+sp_fmt(v)); };
    const activeBars = p.bars.filter(function(b){ return !(b.may===0&&b.apr===0); });
    let rows='';
    activeBars.forEach(function(b){
      if(!hasApr){
        rows+='<div class="numrow"><div class="numrow-name">'+b.n+'</div><div class="numrow-apr" style="color:var(--s-fg4)">—</div><div class="numrow-arrow">→</div><div class="numrow-may neu">'+fmtRmb(b.may)+'</div><div class="numrow-tag neu">—</div></div>';
        return;
      }
      const isNeg=b.apr<0, same=b.may===b.apr;
      let mc,tc,tt;
      ...
      rows+='<div class="numrow"><div class="numrow-name">'+b.n+'</div><div class="numrow-apr">'+fmtRmb(b.apr)+'</div><div class="numrow-arrow">'+(same||b.may===0?'=':'→')+'</div><div class="numrow-may '+mc+'">'+fmtRmb(b.may)+'</div><div class="numrow-tag '+tc+'">'+tt+'</div></div>';
    });
